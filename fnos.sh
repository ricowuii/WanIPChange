...
#导入发送IYUU函数
source /vol1/1000/script/send_iyuu.fun

#设置脚本目录
script_pwd="/vol1/1000/script"
#ipv6网口名称
network_wan="ens3"
#iyuu标题
iyuu_text="FnOSWANIPChanged"
#iyuu token
iyuu_token="IYUU57489Te561fae2c57115d2c158d0438a6df163453b8b51"
#存储IPv6地址的文件
wan_ip="$script_pwd/wan_ip.txt"
#脚本执行log文件
exc_log="$script_pwd/check_wan_ip.log"
